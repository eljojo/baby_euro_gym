...
jsGB = {
  ...
  debug: function() {
	...
	reset: function()
	{
		...
		MMU.load(path.resolve(__filename, '../../test_rom.gb'));
...
GPU = {
  ...
  reset: function() {
    ...
    for(i=0; i<4; i++) {
      GPU._palette.bg[i] = 3;
      GPU._palette.obj0[i] = 3;
      GPU._palette.obj1[i] = 3;
    }
    for(i=0;i<512;i++)
    {
      GPU._tilemap[i] = [];
	...
	break;
      ...
      case 7:
        for(var i=0;i<4;i++)
        {
          switch((val>>(i*2))&3)
          {
            case 0: GPU._palette.bg[i] = 3; break;
            case 1: GPU._palette.bg[i] = 2; break;
            case 2: GPU._palette.bg[i] = 1; break;
      ...
      case 8:
        for(var i=0;i<4;i++)
        {
          switch((val>>(i*2))&3)
          {
            case 0: GPU._palette.obj0[i] = 3; break;
            case 1: GPU._palette.obj0[i] = 2; break;
            case 2: GPU._palette.obj0[i] = 1; break;
      ...
      case 9:
        for(var i=0;i<4;i++)
        {
          switch((val>>(i*2))&3)
          {
            case 0: GPU._palette.obj1[i] = 3; break;
            case 1: GPU._palette.obj1[i] = 2; break;
            case 2: GPU._palette.obj1[i] = 1; break;
